...
import PagosFilterPeriodoDesde from "./pagos-filter-periodo-desde"
import PagosFilterPeriodoHasta from "./pagos-filter-periodo-hasta"
	...
	return (
		<article className="flex flex-col items-center gap-6">
			<div className="flex items-center gap-6">
				<PagosFilterPeriodoDesde />
				<PagosFilterPeriodoHasta />
			</div>
